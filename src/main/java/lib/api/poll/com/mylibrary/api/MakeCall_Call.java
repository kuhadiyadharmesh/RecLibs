...
public class MakeCall_Call
{
    ...
    public MakeCall_Call(MakeCallData data, HeaderCall hdata)
    {
        pollApi = new PollApi();
        this.data = data ;
        this.hdata = hdata;
    ...
    public Common_Response MakeCall_Call()
    {
        ...
        jobj =  pollApi.makeHTTPPOST_SSL(ApiInfo.MakeCall_api,param,hdata);//.makeHTTPPOSTLogin_SSL(ApiInfo.login_api, param);
